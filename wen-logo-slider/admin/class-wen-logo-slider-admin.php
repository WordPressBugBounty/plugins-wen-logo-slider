			...
			<div class="setting-options general-options">
				<p class="first-row">
					...
					<label>
						...
						<input type="checkbox" id="wls-show_title" name="wen_logo_slider_settings[show_title]" value="1" <?php if (isset($settings_args['show_title'])) {
																																checked($settings_args['show_title'], 1, true);
																															} else {
																																echo "checked";
																															} ?> />
				...
				<p>
					...
					<label>
						...
						<input type="checkbox" id="wen_logo_slider_settings[auto_play]" name="wen_logo_slider_settings[auto_play]" value="1" <?php if (isset($settings_args['auto_play'])) {
																																					checked($settings_args['auto_play'], 1, true);
																																				} else {
																																					echo "checked";
																																				} ?> />
				...
				<p>
					...
					<label>
						...
						<input type="checkbox" id="wen_logo_slider_settings[enable_random_order]" name="wen_logo_slider_settings[enable_random_order]" value="1" <?php if (isset($settings_args['enable_random_order'])) {
																																										checked($settings_args['enable_random_order'], 1, true);
																																									} else {
																																										echo "checked";
																																									} ?> />
						<span class="small"><?php esc_html_e('Enable', 'wen-logo-slider'); ?></span>
				...
				<div id="mobile-resolution-options" style="<?php echo (isset($settings_args['wls_enable_mobile_resolution']) && $settings_args['wls_enable_mobile_resolution'] == '1') ? 'display:block' : 'display:none'; ?>">
					<div>
						...
						<div class="ws-breakpoints">
							...
							<?php
							foreach ($breakpoints as $breakpoint => $slides) : ?>
...
<?php
		...
		// );
		echo $output;
		// echo wp_kses($output, $settings_allowed_tags);
	}
